...
// 상위 이탈률 사이트 리스트 send
server.get("/api/get-churn-data", (req, res) => {
...
server.get("/api/get-site-new-member-data", (req, res) => {
...
// 사이트 GMV 데이터 send
server.get("/api/get-site-gmv-data", (req, res) => {
    console.log(req.query.site_code);
...
server.get("/api/get-site-page-view-data", (req, res) => {
    console.log(req.query.site_code);
...
server.get("/api/get-site-order-prod-data", (req, res) => {
    console.log(req.query.site_code);
